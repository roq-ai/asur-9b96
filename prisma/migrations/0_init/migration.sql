...
-- AddForeignKey
ALTER TABLE "participation" ADD CONSTRAINT "participation_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "session"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
